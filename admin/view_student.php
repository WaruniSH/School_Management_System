                        ...
                        <div class="table100-body js-pscroll ps ps--active-y">
                            ...
                            ?>
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column2"><?php    echo "<a onClick=\"javascript:return confirm('Are You Sure to Delete this'); \" class='btn btn-danger' href='delete_student.php?username={$info['username']}'> Delete </a>";  ?></td>
